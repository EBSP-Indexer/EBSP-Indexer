![Alt text](https://github.com/Erlendos12/EBSD-GUI-erlenmos/tree/main/resources/ebsd_gui.png?raw=true "Electron backscatter diffraction - Graphicacl User Interface")
