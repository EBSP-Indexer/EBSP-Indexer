...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionProcessingMenu.setCheckable(False)
        self.actionProcessingMenu.setChecked(False)
        ...
        self.actionToggleJob_Manager.setChecked(False)
        ...
        self.actionPattern_center_refinement = QAction(MainWindow)
        self.actionPattern_center_refinement.setObjectName(u"actionPattern_center_refinement")
        self.actionCalibration_patterns = QAction(MainWindow)
        self.actionCalibration_patterns.setObjectName(u"actionCalibration_patterns")
        self.actionPattern_selection = QAction(MainWindow)
        self.actionPattern_selection.setObjectName(u"actionPattern_selection")
        self.actionAbout3 = QAction(MainWindow)
        self.actionAbout3.setObjectName(u"actionAbout3")
        icon3 = QIcon()
        icon3.addFile(u":/linea_basic/resources/linea_basic_icons/basic_book.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAbout3.setIcon(icon3)
        self.actionGitHub = QAction(MainWindow)
        self.actionGitHub.setObjectName(u"actionGitHub")
        self.actionZenodo = QAction(MainWindow)
        self.actionZenodo.setObjectName(u"actionZenodo")
        ...
        self.dockWidgetSignalNavigation = QDockWidget(self.centralwidget)
        self.dockWidgetSignalNavigation.setObjectName(u"dockWidgetSignalNavigation")
        self.dockWidgetSignalNavigation.setGeometry(QRect(694, 26, 346, 368))
        ...
        self.dockWidgetImageViewer.setMinimumSize(QSize(172, 198))
        ...
        self.gridLayout_3.addWidget(self.jobList, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.threadsLabel, 1, 0, 1, 1)
        ...
        self.menuProcessing.addAction(self.menuPattern_center_optimization.menuAction())
        self.menuPattern_center_optimization.addAction(self.actionCalibration_patterns)
        self.menuPattern_center_optimization.addAction(self.actionPattern_selection)
        ...
        self.menuHelp.addAction(self.actionZenodo)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"EBSP Indexer", None))
        ...
        self.actionPattern_center_refinement.setText(QCoreApplication.translate("MainWindow", u"Pattern center refinement", None))
        self.actionCalibration_patterns.setText(QCoreApplication.translate("MainWindow", u"Calibration patterns", None))
        self.actionPattern_selection.setText(QCoreApplication.translate("MainWindow", u"Pattern selection", None))
        self.actionAbout3.setText(QCoreApplication.translate("MainWindow", u"About", None))
        self.actionGitHub.setText(QCoreApplication.translate("MainWindow", u"GitHub Discussions", None))
        self.actionZenodo.setText(QCoreApplication.translate("MainWindow", u"Zenodo", None))
        ...
        self.menuPattern_center_optimization.setTitle(QCoreApplication.translate("MainWindow", u"Pattern center optimization", None))
