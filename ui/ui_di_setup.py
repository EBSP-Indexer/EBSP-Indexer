...
class Ui_DiSetupDialog(object):
    def setupUi(self, DiSetupDialog):
        ...
        self.gridLayout_4.addWidget(self.patternCenterY, 0, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.patternCenterZ, 0, 5, 1, 1)
        ...
        QWidget.setTabOrder(self.checkBoxMask, self.spinBoxNumIter)
        QWidget.setTabOrder(self.spinBoxNumIter, self.sliderBinning)
        QWidget.setTabOrder(self.sliderBinning, self.comboBoxBinning)
        ...
        QWidget.setTabOrder(self.patternCenterY, self.pushButtonAddPhase)
        QWidget.setTabOrder(self.pushButtonAddPhase, self.checkBoxPM)
        QWidget.setTabOrder(self.checkBoxPM, self.checkBoxNCC)
        QWidget.setTabOrder(self.checkBoxNCC, self.checkBoxIPF)
        QWidget.setTabOrder(self.checkBoxIPF, self.checkBoxOSM)
        QWidget.setTabOrder(self.checkBoxOSM, self.comboBoxFiletype)
