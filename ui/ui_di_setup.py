...
class Ui_DiSetupDialog(object):
    def setupUi(self, DiSetupDialog):
        ...
        self.gridLayout.addWidget(self.checkBoxRefine, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.patternCenterX, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBoxLazy, 6, 2, 1, 1)

        self.lineEditPath = QLineEdit(self.centralwidget)
        self.lineEditPath.setObjectName(u"lineEditPath")

        self.gridLayout.addWidget(self.lineEditPath, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.patternCenterZ, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.patternCenterY, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.listWidgetPhase, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButtonBrowse, 10, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBoxBinning, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxStepSize, 3, 4, 1, 1)

        self.checkBoxMask = QCheckBox(self.centralwidget)
        self.checkBoxMask.setObjectName(u"checkBoxMask")

        self.gridLayout.addWidget(self.checkBoxMask, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxNumIter, 4, 4, 1, 1)
